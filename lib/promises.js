...
function main(){
    ...
    repoSet.push({owner:argv["owner"], repo:argv["repo"]});
    ...
    return new Promise(function(resolve,reject){
        ...
        github.requestAPI(url).then(function(java_file_raw){
            ...
            if (java_file_raw != undefined ){
                    var parsed_file = useion.block.parse(java_file_raw, 'php');
                            ...
                            for (var j in diff.chunks) {
                                ...
                                for (var k in chunk.changes) {
                                    ...
                                    if (change.type === 'add') {
                                        ...
                                        var strung2 = strung.match(/[a-zA-Z][a-zA-Z0-9_]*(->[a-zA-Z][a-zA-Z0-9_]*)+/g);

                                        if (strung2 != null) {

                                            //console.log(strung2);

                                            for (var l in strung2){

                                                //console.log(strung2[l].replace(/->/g," "));
                                                var potential_result = func.fixCamelCase(strung2[l].replace(/->/g," "));
